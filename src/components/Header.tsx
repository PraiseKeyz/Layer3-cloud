...
export default function Header() {
  ...
  return (
    <header className={`fixed w-full top-0 z-50 transition-all duration-300 ${
      isScrolled ? isObjectStorage ? 'bg-white/80 backdrop-blur-md shadow-md' : 'bg-[#002366]/60 backdrop-blur-md shadow-md' : 'bg-transparent'
    }`}>
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="text-2xl font-bold text-gray-900">
              <Image src={isObjectStorage ? logo2 : logo} alt="Layer3Cloud Logo" width={160} height={40} className="mb-2" />
            </Link>
          </div>

          {/* Desktop Navigation */}
          <div className={`hidden lg:flex items-center space-x-8 ${isObjectStorage ? 'text-black' : 'text-white'}`}>
            {/* Product Dropdown */}
            <div 
              className="relative"
