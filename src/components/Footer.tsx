    ...
    <footer className="bg-[#f4f6fc] text-gray-800 pt-16 pb-8 px-4">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-xs text-gray-500">
          Layer3cloud 2025. All right reserved
        </div>
        {/* Social Icons */}
        <div className="flex gap-4 text-red-600 text-xl">
          ...
          <a href="#" aria-label="LinkedIn">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.268c-.966 0-1.75-.784-1.75-1.75s.784-1.75 1.75-1.75 1.75.784 1.75 1.75-.784 1.75-1.75 1.75zm13.5 11.268h-3v-5.604c0-1.337-.025-3.063-1.868-3.063-1.868 0-2.154 1.459-2.154 2.967v5.7h-3v-10h2.881v1.367h.041c.401-.761 1.379-1.563 2.841-1.563 3.039 0 3.602 2.002 3.602 4.604v5.592zm0 0" />
            </svg>
          </a>
          <a href="#" aria-label="YouTube">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M23.498 6.186a2.994 2.994 0 0 0-2.112-2.112C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.386.574a2.994 2.994 0 0 0-2.112 2.112C0 8.072 0 12 0 12s0 3.928.502 5.814a2.994 2.994 0 0 0 2.112 2.112C4.5 20.5 12 20.5 12 20.5s7.5 0 9.386-.574a2.994 2.994 0 0 0 2.112-2.112C24 15.928 24 12 24 12s0-3.928-.502-5.814zM9.545 15.568V8.432l6.545 3.568-6.545 3.568z" />
            </svg>
          </a>
          <a href="#" aria-label="X">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M17.53 2.47a.75.75 0 0 1 1.06 1.06l-5.72 5.72 5.72 5.72a.75.75 0 0 1-1.06 1.06l-5.72-5.72-5.72 5.72a.75.75 0 0 1-1.06-1.06l5.72-5.72-5.72-5.72A.75.75 0 0 1 6.79 2.47l5.72 5.72 5.72-5.72z" />
            </svg>
          </a>
        </div>
        {/* Policy Links */}
