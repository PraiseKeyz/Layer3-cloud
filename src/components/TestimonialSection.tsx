...
const TestimonialSection = ({ testimonials = defaultTestimonials }: TestimonialsSectionProps) => {
  ...
  return (
    <section className="w-full bg-[#E9ECF6] py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 ">
          <span className="text-red-500 font-semibold text-xl block mb-2">Testimonials</span>
          <h2 className="text-4xl font-bold text-gray-800 mb-2">What our clients say</h2>
          <p className="text-gray-800 text-lg">Our Clients&apos; Experience Speaks Volumes</p>
        </div>
