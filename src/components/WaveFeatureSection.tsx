...
export default function WaveFeatureSection({
  ...
  return (
    <section className="relative w-full overflow-hidden min-h-[800px] lg:h-[1200px]">
      ...
      {/* Content */}
      <div className={`relative z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 lg:gap-16 px-4 sm:px-6 lg:px-8 min-h-[800px] lg:min-h-[1200px] lg:items-center${reverse ? ' md:flex-row-reverse' : ''}`}>        
