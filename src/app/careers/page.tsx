    ...
    jobs: [
      {
        ...
        department: "Products",
        description:
          "Lead product development and strategy for new offerings.",
        type: "Full-Time",
        location: "Remote",
        link: "#",
      },
  ...
  return (
    <div className=" py-24">
      ...
      <div className="mx-8 md:mx-24 py-24">
        <h1 className="text-5xl md:text-5xl font-bold text-black max-w-3xl">Build a Career That Shapes Africa’s Digital Future</h1>
      </div>
      ...
      <div className="py-8 mx-auto text-center items-center justify-center"><h3 className="text-[#282828]">Showing roles across all nation and all teams</h3></div>
      {/* Job Card */}
...
<div className="flex items-center justify-between">
  ...
  <a
    href={job.link}
    className="text-[#EB1C29] hidden md:block font-medium text-lg flex items-center hover:underline"
  >
    View Job
    <svg
      className="ml-1"
...
<path d="M17.6569 16.6569C16.7202 17.5935 14.7616 19.5521 13.4138 20.8999C12.6327 21.681 11.3677 21.6814 10.5866 20.9003C9.26234 19.576 7.34159 17.6553 6.34315 16.6569C3.21895 13.5327 3.21895 8.46734 6.34315 5.34315C9.46734 2.21895 14.5327 2.21895 17.6569 5.34315C20.781 8.46734 20.781 13.5327 17.6569 16.6569Z" stroke="#5F5F5F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15 11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11C9 9.34315 10.3431 8 12 8C13.6569 8 15 9.34315 15 11Z" stroke="#5F5F5F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
...
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 8V12L15 15M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#5F5F5F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                {job.type}
              </span>
            </div>
