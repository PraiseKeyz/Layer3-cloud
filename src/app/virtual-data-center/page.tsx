...
const iconMap = {
  ...
  users: (
    ...
    >
      ...
      <path
        d="M8 24C8 20.6863 11.134 18 16 18C20.866 18 24 20.6863 24 24"
        stroke="#2143A6"
        strokeWidth="2"
      />
    </svg>
  ...
  cube: (
    ...
    >
      <rect width="32" height="32" rx="8" fill="#E5EDFF" />
      <path
        d="M16 10L23 13.5V20.5L16 24L9 20.5V13.5L16 10Z"
        stroke="#2143A6"
        strokeWidth="2"
      />
    ...
    <div>
      ...
      <section className="py-30">
        <div className="flex flex-col mx-10 mb-14">
          ...
          <h2 className="text-xl md:text-3xl font-bold max-w-xl text-gray-800">
            Virtual Data Center is adaptable to a wide range of business needs.
          </h2>
        </div>
        <div className="max-w-7xl mx-8 md:mx-24 grid grid-cols-1 md:grid-cols-3 gap-12 px-4">
          {vdcUseCases.map((feature, idx) => (
            <div
              key={idx}
              className="flex flex-col border rounded-xl p-6 bg-white shadow-sm transition hover:shadow-md"
            >
      ...
      <section className="w-full bg-[#E9ECF6] py-16 mb-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 px-6 items-start">
          ...
          <div className="flex-1 flex flex-col items-start md:items-start md:pr-8 mb-8 md:mb-0">
            <span className="text-red-500 font-semibold text-base mb-2">
              Features
            </span>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 max-w-lg">
              Key Features of Virtual Data Center (vDC)
            </h2>
            <button className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-2 rounded mb-8">
              Explore Services
            </button>
          ...
          <div className="flex-1 flex flex-col relative">
            {vdcFeatures.map((feature, idx) => (
              <div
                key={idx}
                className="flex items-start mb-14 last:mb-0 relative"
              >
                {/* Timeline line */}
