...
const supportCards = [
  {
    icon: (
      ...
      >
        ...
        />
        <path
          d="M20 14.2528V27.2528M20 14.2528C18.8321 13.4769 17.2465 13 15.5 13C13.7535 13 12.1679 13.4769 11 14.2528V27.2528C12.1679 26.4769 13.7535 26 15.5 26C17.2465 26 18.8321 26.4769 20 27.2528M20 14.2528C21.1679 13.4769 22.7535 13 24.5 13C26.2465 13 27.8321 13.4769 29 14.2528V27.2528C27.8321 26.4769 26.2465 26 24.5 26C22.7535 26 21.1679 26.4769 20 27.2528"
          stroke="#2143A6"
          stroke-width="2"
    ...
    description:
      "Explore a growing library of easy-to-follow guides, walkthroughs, and FAQs. Designed to help you solve problems fast and learn on the go. No guesswork—just clear, practical answers.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Work with dedicated Success Managers who understand your business goals and help you onboard smoothly, optimize performance, and scale with confidence.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "We offer hands-on support for disaster recovery, enterprise security, and compliance alignment. Our experts design and implement what your business specifically needs.",
  },
];
    ...
    <div>
      ...
      <section className="flex flex-col lg:flex-row items-center justify-center gap-8 py-24 lg:px-0 mx-8 md:mx-16">
        ...
        <div className="w-full lg:flex-1">
          ...
          <p className="text-sm text-[#434343]">
            Our dedicated Nigeria-based support team is available round the
            clock. Whether it&apos;s a quick fix or complex issue, reach us via
            chat, ticket, or call. Get expert help in real time, with zero
            delays. We ensure issues are resolved with speed, clarity, and care.
          </p>
        </div>
      ...
      <section className="py-24 px-4 lg:px-0 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="text-lg font-semibold text-[#EB1C29] mb-2">
            Connect with Us
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-[#282828] mb-4">
            Comprehensive Support
          </h2>
          <p className="text-lg text-[#434343] max-w-2xl mx-auto">
            Enjoy other value add-ons services from our support team ensuring a
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {supportCards.map((card, idx) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-[#282828] mb-2">
                {card.title}
              </h3>
      ...
      <section className="bg-[#F8F9FC] py-24 px-2">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-[#282828] mb-4">
            All-in-One Enterprise Support
          </h2>
          <p className="text-base md:text-sm text-[#434343] max-w-2xl mx-auto">
            Our all-in-one support plan designed to meet the demands of critical
            workloads.
          </p>
        </div>
        {/* Table Data */}
                  ...
                  <div className="bg-[#F8F9FC] px-6 py-5 flex items-center text-[#282828] font-medium text-base">
                    ...
                    {feature.info && (
                      ...
                      >
                        ...
                        <circle cx="12" cy="8" r="1.2" fill="#A0AEC0" />
                      </svg>
                    )}
                  </div>
                  {/* Feature value */}
      ...
      <section className="relative flex flex-col items-center justify-center py-24 md:py-0 lg:py-24 mt-[80%] md:mt-[20%]">
        ...
        <div className="relative z-50 flex flex-col items-center justify-center text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-[#232323] mb-6 leading-tight">
            Ready to Experience
            <br className="hidden md:block" />
            Seamless Cloud Support?
          </h2>
          <p className="text-lg md:text-lg text-[#434343] mb-8 max-w-2xl">
            Let&apos;s help you build, scale, and stay secure—with the support
            you deserve, every step of the way.
          </p>
          <a
            href="/contact"
            className="inline-block px-8 py-3 rounded-md bg-[#EB1C29] text-white font-semibold text-lg shadow-md hover:bg-[#c71a24] transition"
          >
            Talk to Sales
          </a>
        </div>
