...
const industries = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M9.33333 19.3333V24.3333M16 19.3333V24.3333M22.6667 19.3333V24.3333M1 31H31M1 12.6667H31M1 7.66667L16 1L31 7.66667M2.66667 12.6667H29.3333V31H2.66667V12.6667Z"
          stroke="white"
          stroke-width="2"
          stroke-linecap="round"
          stroke-linejoin="round"
    ...
    <div>
      ...
      <section className="py-16 bg-[#F8F9FC]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-[#282828] mb-2">
              Industries We Serve
            </h2>
            <p className="text-[#434343] text-sm max-w-2xl mx-auto">
              Discover how startups, enterprises, and public institutions across
              Africa are leveraging Layer3Cloud to drive innovation, ensure
            ...
            >
              {industries.map((ind, idx) => (
                <div
                  ...
                  style={
                    idx === industries.length - 1 ? { marginRight: 0 } : {}
                  }
                >
                  <Image
                    src={ind.image}
      ...
      <section className="py-16 flex flex-col items-center">
        <div className="mb-10 flex flex-col items-center">
          <h3 className="text-[#EB1C29] mb-4 text-center font-semibold">
            Our Commitment
          </h3>
          <h2 className="text-2xl md:text-4xl mb-4 text-center font-bold text-[#282828]">
            Serving Africa, Built for Africans
          </h2>
          <p className="text-center mb-4 text-[#434343]">
            Whether you&apos;re launching a fintech in Accra or scaling a SaaS
            in Nairobi, Layer3Cloud is your growth partner.
          </p>
          <button className="bg-[#EB1C29] mb-16 hover:bg-red-700 cursor-pointer text-white font-semibold flex px-4 py-2 rounded-lg gap-2 text-sm shadow transition-colors">
            Talk to sales{" "}
            <svg
              width="17"
              height="16"
            ...
            >
              <path
                d="M11.8333 5.33594L14.5 8.0026M14.5 8.0026L11.8333 10.6693M14.5 8.0026L2.5 8.0026"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
