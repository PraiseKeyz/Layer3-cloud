...
export default function ObjectStoragePage() {
  ...
  <div className="absolute inset-0 w-full max-w-[1440px] mx-auto h-full" style={{ aspectRatio: '1440 / 1200' }}>
    <Image
      src={caseStudiesBg}
