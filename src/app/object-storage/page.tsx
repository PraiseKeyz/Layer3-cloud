...
const objectStorageFeatures = [
  {
    ...
    description:
      "Easily integrate with existing tools and workflows using a fully S3-compatible API—no need to re-architect or change your storage strategy.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Effortlessly scale from gigabytes to petabytes without performance drops—built to grow with your data, no matter the size.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Your data is always accessible and protected—engineered for 99.999% durability and minimal downtime, even during failures.",
  },
];
const faqs = [
  {
    ...
    answer:
      "Yes, Layer3 Object Storage is fully S3-compatible, allowing you to use existing tools and SDKs.",
  },
  {
    question: "What are typical use cases for Object Storage?",
    answer:
      "Backup, DR, media storage, analytics, AI datasets, and multi-cloud integrations.",
  },
  {
    question:
      "Can I integrate Object Storage into my existing backup or media workflows?",
    answer:
      "Yes, you can seamlessly integrate with your existing workflows using our S3-compatible API.",
  },
  {
    question: "Is there a minimum storage requirement or contract?",
    answer:
      "No, there is no minimum storage requirement or long-term contract. Pay only for what you use.",
  },
  {
    question:
      "How does billing work for Object Storage—do I pay for used or allocated space?",
    answer:
      "You are billed for the actual storage used, not for allocated space.",
  },
];
...
const objectStorageUseCases = [
  {
    ...
    title: "Backup & DR",
    description:
      "Automatically store snapshots, backups, and recovery data with built-in redundancy and encryption—seamlessly integrate with tools like Veeam or Velero to automate workflows and ensure your data is protected.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Store and serve high-quality video, audio, and image files with ease—perfect for web apps, mobile platforms, and content-heavy services that demand speed, scalability, and reliability.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Store and access large datasets for machine learning, AI training, and analytics workflows—built for performance, scalability, and easy integration with your data pipelines and cloud-native tools.",
  },
  {
    icon: (
      <svg
      ...
      >
        ...
        />
        <path
          d="M18.6998 33.4016C15.9936 33.4016 13.7998 31.2078 13.7998 28.5016C13.7998 25.9698 15.7199 23.8866 18.1832 23.6285C18.0635 23.1729 17.9998 22.6947 17.9998 22.2016C17.9998 19.1088 20.507 16.6016 23.5998 16.6016C26.2302 16.6016 28.437 18.4151 29.0381 20.86C29.3198 20.8215 29.6075 20.8016 29.8998 20.8016C33.3792 20.8016 36.1998 23.6222 36.1998 27.1016C36.1998 30.581 33.3792 33.4016 29.8998 33.4016H18.6998Z"
          fill="#2143A6"
        />
      </svg>
    ),
    ...
    description:
      "Seamless data movement across clouds—easily integrate with public and private cloud environments to enable flexibility, avoid vendor lock-in, and support your evolving infrastructure strategy.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeroSection
        ...
        heroImageAlt="Object Storage Hero Section"
        heading="Object Storage"
        description="S3-compatible object storage solution for scalable, secure, and resilient data storage."
        breadcrumbText="Object Storage"
      />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {objectStorageUseCases.map((useCase, idx) => (
              <div
                key={idx}
                className="flex flex-row items-start bg-white border border-gray-200 rounded-2xl p-8 gap-6 shadow-sm"
              >
                {/* Icon placeholder */}
